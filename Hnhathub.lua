...
player.Idled:Connect(function()
    ...
    if CFG.Debug then print("🛡️ [Anti-AFK] Đã giả lập tương tác để giữ kết nối!") end
end)
-- ═══════════════════════════════════════════════════
...
local statusLbl = Instance.new("TextLabel"); statusLbl.Size = UDim2.new(1,-16,0,14); statusLbl.Position = UDim2.new(0,8,0,117); statusBackgroundTransparency = 1; statusLbl.Font = Enum.Font.Gotham; statusLbl.TextSize = 10; statusLbl.TextColor3 = Color3.fromRGB(100,100,130); statusLbl.Text = "○ Đợi câu..."; statusLbl.TextXAlignment = Enum.TextXAlignment.Left; statusLbl.Parent = panel
